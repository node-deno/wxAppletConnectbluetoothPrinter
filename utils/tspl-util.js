...
var printer = {
  createNew: function () {
     ...
     */
    printer.setSize = function (pageWidght, pageHeight) {
     ...
     * 标签间隙 单位mm
     */
    printer.setGap = function (printGap) {
     ...
     * 黑标高度 单位mm
     */
    printer.setBline = function (printBline) {
     ...
     * 纸张停止的距离 单位mm 
     */
    printer.setOffset = function (offset) {
     ...
     * 实际支持速度以自检页为准
     */
    printer.setSpeed = function (printSpeed) {
     ...
     * 1<=printDensity<=15
     */
    printer.setDensity = function (printDensity) {
     ...
     */
    printer.setDirection = function (direction) {
     ...
     */
    printer.setReference = function (x, y) {
      data = "REFERENCE " + x + "," + y + "\r\n";
      printer.addCommand(data)
    };
    /**
     ...
     *  049:German
     */
    printer.setCountry = function (country) {
     ...
     * 1001:PC1001
     */
    printer.setCodepage = function (codepage) {
     ...
     * 打印机分辨率300 DPI:1 mm = 12 dots
     */
    printer.setBackFeed = function (backup) {
     ...
     */
    printer.setBox = function (x_start, y_start, x_end, y_end, thickness) {
     ...
     * content 打印内容
     */
    printer.setBarCode = function (x, y, codetype, height, readable, rotation, narrow, wide, content) {
     ...
     * res为画布参数
     */
    printer.setBitmap = function (x, y, mode, res) {
      console.log(res)
      var w = res.width;
      var h = res.height;
     ...
     */
    printer.setErase = function (x_start, y_start, x_width, y_height) {
     ...
     * y_height 反相区域高度，单位dot
     */
    printer.setReverse = function (x_start, y_start, x_width, y_height) {
     ...
     */
    printer.setText = function (x, y, font, rotation, x_, y_, str) {
     ...
     * content  内容
     */
    printer.setQrcode = function (x, y, level, width, mode, content) {
     ...
     * OFF 禁用撕纸位置走到撕纸处，命令在起始位置有效
     */
    printer.setStripper = function (n) {
